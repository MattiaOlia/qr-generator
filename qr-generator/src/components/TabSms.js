...
export default function TabSms() {
  ...
  >
      <Box
        ...
        pb={12}
      >
        <TextField inputName={"input1"} isCancelClicked={isCancelClicked} setIsCancelClicked={setIsCancelClicked} row={1} addLine={true} textPlaceholder={"Insert your number"} />
        <TextField inputName={"input2"} isCancelClicked={isCancelClicked} setIsCancelClicked={setIsCancelClicked} row={3} textPlaceholder={"Insert your text"} />
        <Box
          p={1}
          display={'flex'}
          alignItems={'center'}
